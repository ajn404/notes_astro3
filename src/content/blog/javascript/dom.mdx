...
import ChangeCss from "@components/astro/dom/changeCssVar.astro";
...
<ChangeCss client:load></ChangeCss>
...
```js
 ...
 document.addEventListener('DOMContentLoaded', () => {
    ...
    changeButton.addEventListener('click', () => {
        ...
        const primaryColor = getComputedStyle(root).getPropertyValue('--color-text-base');
...
import InsertNode from "@components/astro/dom/insertNode.astro";

<InsertNode client:load></InsertNode>
...
import SyncScroll from "@components/astro/dom/SyncScroll.astro";

<SyncScroll client:load></SyncScroll>
