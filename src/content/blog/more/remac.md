...
## [another cheatsheet](https://devhints.io/vim)
...
[neovide 配置](https://neovide.dev/configuration.html)
...
import Shoelace from '@components/react/shoelace/index.astro'

<Shoelace />

```mdx
import Shoelace from '@components/react/shoelace/index.astro'
<Shoelace client:load/
