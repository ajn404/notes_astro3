...
<div class="m-auto flex w-4/5 justify-between">
  <img
    src="/notes_astro3/assets/2023.jpg"
    class=" w-1/3 rounded-lg shadow-lg dark:shadow-black/20"
    alt="about learning"
  />
  <video
    ...
    type="video/mp4"
    loop
    class="clip w-1/3 rounded-lg shadow-lg dark:shadow-black/20"
  />
</div>
  ...
  <ol class="border-info-100 list-none border-l-2">
    <li>
      <div class="flex-start md:flex">
        ...
        <div class="bg-neutral-50 dark:bg-neutral-700 mb-10 ml-6 block max-w-full rounded-lg p-6 shadow-md shadow-black/5 dark:shadow-black/10">
      ...
      <div class="flex-start md:flex">
        ...
        <div class="bg-neutral-50 dark:bg-neutral-700 mb-10 ml-6 block max-w-full rounded-lg p-6 shadow-md shadow-black/5 dark:shadow-black/10">
          ...
          <p class="text-neutral-700 dark:text-neutral-200 mb-6">
            ...
            关于p5js,ecma,glsl,threejs,vtkjs,rust和一些总结，vuepress能追溯到我的大学使馆gg
          </p>
        </div>
      </div>
    </li>
