import{j as e}from"./jsx-runtime.b792ae09.js";import{r as n}from"./index.499fac84.js";import{s as c,V as a,e as l,C as p,u as d,b as m}from"./shaderMaterial.6f9b6fdb.js";import"./_commonjsHelpers.de833af9.js";const u=` 
    void main() {
...
`,r=c({resolution:new a},u,v);l({CircleMaterial:r});function x(){const i=n.useRef(),{viewport:o,size:t}=d();return m((h,s)=>{i.current.time+=s}),e.jsxs("mesh",{scale:[o.width,o.height,1],children:[e.jsx("planeGeometry",{}),e.jsx("circleMaterial",{ref:i,resolution:[t.width*o.dpr,t.height*o.dpr]},r.key)]})}function w(){return e.jsx(p,{style:{height:"300px",margin:"auto"},children:e.jsx(x,{})})}export{w as default};
